...
export interface LandNFTInterface extends Interface {
  ...
  encodeFunctionData(
    functionFragment: "landRegistryAddress",
    values?: undefined
  ): string;
  encodeFunctionData(
    functionFragment: "mintLandToken",
...
export interface LandNFT extends BaseContract {
  ...
  landRegistryAddress: TypedContractMethod<[], [string], "view">;

  mintLandToken: TypedContractMethod<
  ...
  >;
  getFunction(
    nameOrSignature: "landRegistryAddress"
  ): TypedContractMethod<[], [string], "view">;
  getFunction(
    nameOrSignature: "mintLandToken"
  ): TypedContractMethod<
    [to: AddressLike, tokenId: BigNumberish, uri: string],
    [void],
    "nonpayable"
